...
fn main() {
  ...
  for i in start..upto {
    println!("{}% | {} / {}", (i - start) * 100 / (upto - start), i - start, upto - start);
    ...
    handler(&format!("./dist/{0: >08}.png", i), ((file_size_height as f64 * aspect_ratio) as usize, file_size_height as usize), upper_left, lower_right)
  }
}
